...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        /*
            Creates an New instance of tour maps and
            set the layout parameters to the params
        ...
        /*
            create a handler on modebutton and click listener for
            inflated pop up menu items.
         */
    ...
    /*
        resets the map variable and changes the
